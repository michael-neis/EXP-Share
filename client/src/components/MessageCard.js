...
function MessageCard({message, currentUser}){
    ...
    return(
        ...
        return(
            ...
            <img className="nes-bcrikko" alt='friend profile' title={message.sender.username} src={message.sender.profile_pic ? message.sender.profile_pic : 'https://t4.ftcdn.net/jpg/00/64/67/63/360_F_64676383_LdbmhiNM6Ypzb3FM4PPuFP9rHe7ri8Ju.jpg'}/>
